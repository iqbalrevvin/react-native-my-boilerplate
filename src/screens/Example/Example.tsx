...
import { useLazyFetchOneQuery } from '../../api/modules/users';
...
const Example = (props: any) => {
  ...
  const [fetchOne, { data, error, isSuccess, isLoading, isFetching }] =
  ...
  const onChangeLanguage = (lang: 'id' | 'en') => {
      ...
      >
        ...
        >
          ...
          <TouchableOpacity
            style={[Common.button.circle, Gutters.regularBMargin]}
            onPress={() =>
              onChangeLanguage(i18next.language === 'id' ? 'en' : 'id')
            }
          >
            <Image
